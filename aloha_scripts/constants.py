...
MY_MASTER_START_ARM_POS = [0, -0.96, 1.16, 0, -0.3, 0.0, 0.02239, 0.3]
 # note: absolute path
# 2024 0304 NEW Gripper
# Left finger position limits (qpos[7]), right_finger = -1 * left_finger
MASTER_GRIPPER_POSITION_OPEN = 0.7041      #0.8520
MASTER_GRIPPER_POSITION_CLOSE = -0.0598    #-0.0521
PUPPET_GRIPPER_POSITION_OPEN = -1.4572    #-1.3250
PUPPET_GRIPPER_POSITION_CLOSE = -2.261    #-2.5630

# Gripper joint limits (qpos[6])
MASTER_GRIPPER_JOINT_OPEN = 0.72        #0.4900
MASTER_GRIPPER_JOINT_CLOSE = 0.1000
PUPPET_GRIPPER_JOINT_OPEN = -1.6380        #-1.7800
PUPPET_GRIPPER_JOINT_CLOSE = -2.400


# Original 1st generation
#NEW_MASTER_GRIPPER_POSITION_OPEN = 0.02417
#NEW_MASTER_GRIPPER_POSITION_CLOSE = 0.01244
#NEW_PUPPET_GRIPPER_POSITION_OPEN = 0.05800
#NEW_PUPPET_GRIPPER_POSITION_CLOSE = 0.01844


#NEW_MASTER_GRIPPER_JOINT_OPEN = 0.3083
#NEW_MASTER_GRIPPER_JOINT_CLOSE = -0.6842
#NEW_PUPPET_GRIPPER_JOINT_OPEN = 1.4910
#NEW_PUPPET_GRIPPER_JOINT_CLOSE = -0.6213
