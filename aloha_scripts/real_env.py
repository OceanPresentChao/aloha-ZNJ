...
class RealEnv:
    ...
    def get_qpos(self):
        ...
        left_gripper_qpos = [PUPPET_GRIPPER_JOINT_NORMALIZE_FN(left_qpos_raw[7])]
        right_gripper_qpos = [PUPPET_GRIPPER_JOINT_NORMALIZE_FN(right_qpos_raw[7])]
    ...
    def _reset_joints(self):
        reset_position = PUPPET_START_ARM_POSE[:6]
        move_arms(
